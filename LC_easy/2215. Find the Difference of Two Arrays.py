...
if __name__ == "__main__":
    s = Solution()
    assert s.findDifference(nums1 = [1,2,3], nums2 = [2,4,6]) == [[1,3],[4,6]]
    assert s.findDifference(nums1 = [1,2,3,3], nums2 = [1,1,2,2]) == [[3],[]]
...
and answer[0] = [3]. Every integer in nums2 is present in nums1. Therefore, answer[1] = [].
