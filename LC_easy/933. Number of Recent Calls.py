class RecentCounter:
    ...
    def ping(self, t: int) -> int:
        ...
        while self.records[self.start] < t - 3000: # We start only if our starting point is too old already, else we return
            print(self.records[self.start], t-3000)
            self.start += 1
...
if __name__ == "__main__":
    # s = RecentCounter()
    #
    # assert s.ping([[], [1], [100], [3001], [3002]] == [1, 2, 3, 3]
