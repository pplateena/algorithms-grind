class Solution:
    def numUniqueEmails(self, emails: list[str]) -> int:
        ...
        for email in emails:
            ...
            working_parts = email.split('@')
            prefix, suffix = working_parts[0], working_parts[1]
            ...
            for letter in prefix:
                ...
                if letter == ".":
                    ...
                    prefixFinished.append(letter)
            prefixFinished = str(prefixFinished)

            actualEmail = prefixFinished + "@" + suffix

            actual_emails.add(actualEmail)
